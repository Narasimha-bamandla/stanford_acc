  ...
  return (
    <>
      <section className="cr_switch_event">
        ...
        <div class="accordionGroup d-flex flex-column c-gap-2">
                ...
                <div className="event ">
                  ...
                  <div className="event_head">
                    <button
                      ...
                      aria-controls={
                        "panel" +
                        switchData?.section.replace(/\s+/g, "").toLowerCase() +
                        coreIndex
                      }
                      aria-labelledby={
                        "accordionid" +
                    ...
                    isContentLoading ? (
                      ...
                      <>
                                ...
                                {switchContent?.switchToOptions?.map(
                                  (content, contentIndex) => {
                                    return (
                                      <>
                                        <section
                                          className={`d-flex c-gap-2 align-items-start pl-2  pt-2  pr-0 frm-item ${
                        ...
                        {openCards[switchData?.section] &&
                          switchContent?.isGroupEditable && (
                            <div
                              className="btn-group push-right w-auto "
                              style={{
                                position: "absolute",
                                right: 20,
                                top: 12,
